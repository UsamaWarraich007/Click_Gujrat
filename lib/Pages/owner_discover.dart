...
class OwnerDiscover extends StatefulWidget {
  const OwnerDiscover({Key? key}) : super(key: key);

  @override
  _OwnerDiscoverState createState() => _OwnerDiscoverState();
}

class _OwnerDiscoverState extends State<OwnerDiscover> {
  @override
  Widget build(BuildContext context) {
    return StreamProvider<List<Place>?>.value(
      value: LocationServices().fetchApprovedPlacesAsStreamByUID(),
      initialData: const [],
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              var items = LocationServices()
                  .searchPlacesAsStreamByUID(category: category);
              return Column(
