...
class _DiscoverState extends State<Discover> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<Place>?>.value(
      value: LocationServices().fetchApprovedPlacesAsStream(),
      initialData: const [],
            ...
            itemBuilder: (context, index) {
              ...
              return Column(
                ...
                children: [
                  ...
                  //   child:
                  //   BigText(text: "Hospitals", size: 25, color: Colors.black),
                  // ),
                  ...
                  //                     image: DecorationImage(
                  //                       fit: BoxFit.cover,
                  //                       image: AssetImage("assets/resturent.jpg"),
                  //                     )),
                  //               ),
                  //               //all text
                  //               Container(
                  ...
                  //   padding: EdgeInsets.only(left: 15, top: 30, bottom: 20),
                  //   child:
                  //   BigText(text: "Hostels", size: 25, color: Colors.black),
                  // ),
                  // SingleChildScrollView(
                  //   scrollDirection: Axis.horizontal,
                  //   child: Row(
                  ...
                  //   padding: EdgeInsets.only(left: 15, top: 30, bottom: 20),
                  //   child: BigText(
                  //       text: "Universities", size: 25, color: Colors.black),
                  // ),
                  // SingleChildScrollView(
                  //   scrollDirection: Axis.horizontal,
                  //   child: Row(
                  ...
                  //   padding: EdgeInsets.only(left: 15, top: 30, bottom: 20),
                  //   child:
                  //   BigText(text: "College", size: 25, color: Colors.black),
                  // ),
                  // SingleChildScrollView(
                  //   scrollDirection: Axis.horizontal,
                  //   child: Row(
                  ...
                  // Container(
                  //   padding: EdgeInsets.only(left: 15, top: 30, bottom: 20),
                  //   child: BigText(text: "School", size: 25, color: Colors.black),
                  // ),
                  // SingleChildScrollView(
                  //   scrollDirection: Axis.horizontal,
                  //   child: Row(
